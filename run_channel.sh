#!/bin/bash
# run_channel.sh — Run dolfinx-rans k-omega channel flow solver
#
# Usage:
#   ./run_channel.sh                       # Serial, canonical channel case (default)
#   ./run_channel.sh 8                     # 8 MPI processes, canonical channel case
#   ./run_channel.sh path/to/config.jsonc  # Serial, custom config
#   ./run_channel.sh path/to/config.json   # Serial, custom config
#   ./run_channel.sh 4 path/to/config.jsonc # 4 MPI processes, custom config
...
# ─────────────────────────────────────────────────────────────────────────────
echo "═══════════════════════════════════════════════════════════════════════"
echo "  dolfinx-rans: RANS k-omega Channel Flow Solver"
echo "═══════════════════════════════════════════════════════════════════════"
...
case "$CONFIG_ARG" in
    ...
    *)
        ...
        echo "Usage: ./run_channel.sh [NPROCS] [channel|path/to/config.jsonc]"
        exit 1
        ;;
esac
...
python -c "
import sys
from dolfinx_rans.utils import load_json_config
